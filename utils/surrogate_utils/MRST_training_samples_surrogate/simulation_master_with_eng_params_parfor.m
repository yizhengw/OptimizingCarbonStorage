...
if CLUSTER
    ...
    poolobj = gcp;
    addAttachedFiles(poolobj,{'createWellSchedule_CCS.m'})
...
% Plotting Injection pressure
% plot(injector_bhps(:,1))
% set(gca,'FontSize',18)
% title('CO2 Injector', 'FontSize', 18);
% xlabel('Time Step', 'FontSize',18);
% ylabel( 'Injection Pressure', 'FontSize', 18);
