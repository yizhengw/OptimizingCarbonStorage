...
class volume_to_scalar(nn.Module):
    def __init__(self):
        ...
        self.cnn0 = nn.Conv3d(30, 30, (2, 2, 2), stride = 2)
        self.cnn1 = nn.Conv3d(30, 30, (2, 2, 2), stride = 2)
    
        self.bncnn0 = nn.BatchNorm3d(30)
        self.bncnn1 = nn.BatchNorm3d(30)
...
class sg_to_mass(nn.Module):
    def __init__(self):
        super(sg_to_mass, self).__init__()
        self.sg = volume_to_scalar()

        self.fc11 = nn.Linear(24000, 100)
        self.fc12 = nn.Linear(105, 30)
        
        self.fc21 = nn.Linear(24000, 100)
        self.fc22 = nn.Linear(105, 30)
        
        self.fc31 = nn.Linear(24000, 100)
        self.fc32 = nn.Linear(105, 30)
...
class sg_inj(nn.Module):
    def __init__(self, sg_model, mass_model):
        super(sg_inj, self).__init__()
    ...
    def forward(self, x, param):
        ...
        sg_pred = sg_pred * 0.11581799258656186 + 0.020241330689676987
