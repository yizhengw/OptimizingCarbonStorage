...
for countt in 1:10
    ...
    save_dir_prefix = string("/home/ccs/Expert2_new_model_seed",countt,"/")
    ...
    #well_locs = [10,20,30,40]
    well_locs = [CartesianIndex(10, 10, 1),
                 CartesianIndex(35, 8, 1),
                 CartesianIndex(18, 22, 1),
                 CartesianIndex(20, 45, 1)]
    ...
    while !isterminal(m, s0)
        ...
        #a = CartesianIndex(well_locs[t+1], well_locs[t+1], 1)
        a = well_locs[t+1]
