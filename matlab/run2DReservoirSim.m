% run_reservoir_simJULIA_splitted

%%% Input Vars %%%
% TAU: Tortuosity of the rock
% AV: Specific surface area of the rock
% POROSITY: NL by NW array of porosity values for each grid cell
% KZ: NL by NW array of vertical permiability values for each grid cell in mDarcy
% KXY: NL by NW array of horizontal permiability values for each grid cell in mDarcy
% W_COORDS: m-by-2 array of well coordinates, ordered by placement order
